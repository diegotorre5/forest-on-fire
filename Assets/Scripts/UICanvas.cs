...
public class UICanvas: MonoBehaviour
{
    ...
    public void ModeChange() {
        ...
        switch (dropdownMode.GetComponentInChildren<Text>().text) {
            case "Add":
                gameManagerScript.clickMode = GameManager.ClickMode.add;
                break;
            case "Remove":
                gameManagerScript.clickMode = GameManager.ClickMode.remove;
                break;
            case "Fire":
                gameManagerScript.clickMode = GameManager.ClickMode.fire;
                break;
        }
